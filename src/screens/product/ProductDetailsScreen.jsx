      ...
      <Container>
        ...
        <DetailsContent className="grid">
          ...
          <ProductDetailsWrapper>
            ...
            <section className="lex items-center rating-and-comments flex-wrap">
              ...
              <div className="prod-comments flex items-start">
                <span className="prod-comments-icon text-gray">
                  <i className="bi bi-chat-left-text"></i>
                </span>
                <span className="prod-comment-text text-sm text-gray">
                  {product_one.comments_count} commnt(s)
                </span>
              </div>
            </section>
            ...
            <ProductSizeWrapper>
              <div className="prod-size-top flex items-center flex-wrap">
                ...
                <Link to={"/"}
                  className="text-lg text-gray font-medium"
                >
                  Size Guide &nbsp; 
              ...
              <div className="prod-size-list flex items-center">
                {product_one?.sizes?.map((size, index) => (
                  <div key={index} className="prod-size-item">
            ...
            <ProductColorWrapper>
                ...
                <div className="prod-colors-list flex items-center">
                  {product_one?.colors?.map((color, index) => (
                    <div key={index} className="prod-colors-item">
                      <input type="radio" name="color" />
                      <span className="prod-colorbox" 
            ...
            <section className="btn-and-price flex items-center flex-wrap">
              <BaseLinkGreen 
                to={'/cart'} 
                as={BaseLinkGreen} 
