...
const ShippingPayment = () => {
  return (
    <ShippingPaymentWrapper>
      <section className="shipping-addr">
        <h3 className="text-xxl shipping-addr-title">
          Shipping Address
        </h3>
      ...
      <section className="shipping-method">
        <h3 className="text-xxl shipping-method-title">
          Shipping Address
        </h3>
      ...
      <section className="payment-method">
        <h3 className="text-xxl payment-method-title">
          Payment Method
        </h3>
        <p className="text-base text-outerspace">
