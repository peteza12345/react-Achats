    ...
    <CheckoutSummaryWrapper>
      ...
      <div className="order-list grid">
        {orderData[0]?.items?.map((order) => (
          <div key={order.id} className="order-item grid">
            <section className="order-item-img">
              <img src={order.imgSource} alt={order.name} className="object-fit-cover" />
            </section>

            <section className="order-item-info flex justify-between">
